...
const NavMobile:React.FC<Props> = ({setShown})=> {
  ...
  return (
    <div className=" md:hidden grid grid-rows-7 text-black  select-none	  font-pirata font-bold text-2xl py-2 fixed w-69 top-0 z-20 left-0 h-screen px-2 select-none bg-[#f8f9fa]">
